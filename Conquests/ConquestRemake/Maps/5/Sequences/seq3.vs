...

{
	...
	b.Research("Barbaric Tales");
	b.Research("TReligiousFeast");
	b.Research("German chamber");
	EnvWriteInt(2, "MaxAxemen", 20);
	EnvWriteString(2, "Increase Axe production", "researched");

	b = NO_Town3.obj.AsBuilding();
	b.Research("Attack focus");
	b.Research("TReligiousFeast");
	b.Research("German chamber");
	EnvWriteInt(3, "MaxHuntresses", 20);
	EnvWriteString(3, "Increase Javelin production", "researched");

	b = NO_Town4.obj.AsBuilding();
	b.Research("Learning");
	b.Research("TReligiousFeast");
	b.Research("German chamber");
	EnvWriteInt(4, "MaxTeutonRiders", 20);
	EnvWriteString(4, "Increase Horseshoe production", "researched");
