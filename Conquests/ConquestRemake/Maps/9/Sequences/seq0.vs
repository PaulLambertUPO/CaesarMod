Settlement set2, set3, set4, set5, set6, set7, set8, set9;
int difficulty;
...
set8 = GetSettlement("S_Town8");
set9 = GetSettlement("S_Town9");

set2.Research("ChooseImperialRome");
set3.Research("ChooseRepublicanRome");
set4.Research("ChooseRepublicanRome");
set5.Research("ChooseImperialRome");

{
	Building b;

	b = NO_Town2.obj.AsBuilding();
	b.Research("Roman Principle");
	b.Research("Wrath of Jupiter");
	b.Research("Liberati guild");
	b.Research("Liberati triumph");

	b = NO_Town3.obj.AsBuilding();
	b.Research("Roman Principle");
	b.Research("Roman Chariot Wheels");
	b.Research("Wrath of Jupiter");

	b = NO_Town4.obj.AsBuilding();
	b.Research("Roman Full Armor");
...
if (difficulty == 0) {
	...
	EnvWriteString(set2, "StartingBonusP5", "BonusGold20");
	...
	EnvWriteString(set3, "StartingBonusP5", "BonusGold20");
	...
	EnvWriteString(set4, "StartingBonusP5", "BonusGold20");
	...
	EnvWriteString(set5, "StartingBonusP5", "BonusGold20");
	...
	EnvWriteString(set6, "StartingBonusP5", "BonusGold20");
	...
	EnvWriteString(set7, "StartingBonusP5", "BonusGold20");
	EnvWriteString(set7, "StartingBonusP7", "BonusGold20");
	EnvWriteString(set7, "StartingBonusP8", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP2", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP3", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP4", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP5", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP7", "BonusGold20");
	EnvWriteString(set8, "StartingBonusP8", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP2", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP3", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP4", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP5", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP7", "BonusGold20");
	EnvWriteString(set9, "StartingBonusP8", "BonusGold20");
}
else {
	set2.SetFood(5000);
	set2.SetGold(8000);
	...
	EnvWriteString(set2, "StartingBonusP5", "BonusGold50");
	...
	EnvWriteString(set3, "StartingBonusP5", "BonusGold50");
	...
	EnvWriteString(set4, "StartingBonusP5", "BonusGold50");
	...
	EnvWriteString(set5, "StartingBonusP5", "BonusGold50");
	...
	EnvWriteString(set6, "StartingBonusP5", "BonusGold50");
	...
	EnvWriteString(set7, "StartingBonusP5", "BonusGold50");
	EnvWriteString(set7, "StartingBonusP7", "BonusGold50");
	EnvWriteString(set7, "StartingBonusP8", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP2", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP3", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP4", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP5", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP7", "BonusGold50");
	EnvWriteString(set8, "StartingBonusP8", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP2", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP3", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP4", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP5", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP7", "BonusGold50");
	EnvWriteString(set9, "StartingBonusP8", "BonusGold50");
}
...
while (1) {
	if (difficulty == 1) {
		...
		if (!set8.IsIndependent())
			if (set8.player != 1)
				set8.SetGold(set8.gold + 20);
		if (!set9.IsIndependent())
			if (set9.player != 1)
				set9.SetGold(set9.gold + 20);
	}
		...
		if (set7.player != 1)
			set7.SetGold(set6.gold + 50);
		if (!set8.IsIndependent())
			if (set8.player != 1)
				set8.SetGold(set8.gold + 50);
		if (!set9.IsIndependent())
			if (set9.player != 1)
				set9.SetGold(set9.gold + 50);
	}
	Sleep(2000);
}